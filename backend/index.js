...
try {
    mongoose.connect('mongodb+srv://kenechukwuajimah:1601413@cluster0.j2ntlll.mongodb.net/eCommerce?retryWrites=true&w=majority&appName=Cluster0')
...
app.get('/' ,(req, res) => {
    res.send('express app app is running')
});
...
//creating endpoint for registering the the user
...
//creating endpoints for users login
...
app.post('/login', async (req, res) => {
    try {
        ...
        const token = jwt.sign(data, 'secret_ecom', { expiresIn: '1h' }); // Secret key and token expiration time
